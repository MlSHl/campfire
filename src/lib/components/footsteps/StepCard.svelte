...
>
    <div class="flex h-full flex-col rounded-2xl border border-orange-200 bg-orange-50 shadow-sm dark:border-stone-800 dark:bg-[#151a28]">
        <div class="flex items-center justify-between gap-3 border-b border-orange-200 px-4 py-3 dark:border-stone-800">
            ...
            <input
                ...
                class="min-w-0 flex-1 pb-3 text-2xl font-semibold text-center text-zinc-900 placeholder:text-zinc-400 focus:outline-none dark:text-zinc-100 dark:placeholder:text-zinc-500"
            />
        ...
        <div class="flex-1 p-4">
            <textarea
                ...
                class="h-full w-full resize-none text-base leading-7 text-zinc-800 placeholder:text-zinc-400 focus:outline-none dark:text-zinc-200 dark:placeholder:text-zinc-500"
            ></textarea>
        </div>
